...
class SensorsControllerTest < ActionController::TestCase
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post :create, sensor: { address: @sensor.address, name: @sensor.name, reading: @sensor.reading, unit: @sensor.unit }
    end
  ...
  test "should update sensor" do
    patch :update, id: @sensor, sensor: { address: @sensor.address, name: @sensor.name, reading: @sensor.reading, unit: @sensor.unit }
    assert_redirected_to sensor_path(assigns(:sensor))
  end
